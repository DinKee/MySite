            ...
            <tbody class="u-table-body">
              <?php
                ...
                if (isset($_POST["search"])) {
                  $tea_name_sel = $_POST["tea_name_select"];
                ...
                if (!($t_name_ch == "" && $d_begin == "" && $d_end == "" && $tea_name_sel == "茶種")){
                  if($t_name_ch == ""){
                    $purchase_sql = " SELECT * FROM purchase WHERE (tea_date BETWEEN '$d_begin' AND '$d_end') OR tea_type = '$tea_name_sel' ";
                    $sell_sql = " SELECT * FROM tea_order WHERE (tea_date BETWEEN '$d_begin' AND '$d_end') OR tea_type = '$tea_name_sel' ";
                  }else{
                    $purchase_sql = " SELECT * FROM purchase WHERE tea_type LIKE '%$t_name_ch%' OR (tea_date BETWEEN '$d_begin' AND '$d_end') OR tea_type = '$tea_name_sel' ";
                    $sell_sql = " SELECT * FROM tea_order WHERE tea_type LIKE '%$t_name_ch%' OR (tea_date BETWEEN '$d_begin' AND '$d_end') OR tea_type = '$tea_name_sel' ";
                  }
                  $_SESSION["purchase_search"] = $purchase_sql;
                  $_SESSION["sell_search"] = $sell_sql;
                  header("Location: total_result.php");
                }
               
                $purchase_sql = "SELECT * FROM purchase";
                $sell_sql = " SELECT * FROM tea_order";
