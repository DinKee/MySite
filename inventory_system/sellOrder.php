          ...
          <table class="u-table-entity u-table-entity-1">
            ...
            <?php
                ...
                while ($rows = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                  ...
                  echo "<a href='' onclick=''><img src='https://cdn0.iconfinder.com/data/icons/glyphpack/45/edit-alt-512.png' height='40px'></img></a></td>";
                  echo "<td class='u-border-1 u-border-grey-30 u-border-no-left u-border-no-right u-table-cell'>";
          ...
          <?php
            ...
            if (isset($_POST["send"])) {
              ...
              if(!empty($row["order_ID"])){           
                ...
                $m_id = $m_row["m_ID"];
                $insert_sql = "INSERT INTO tea_order (tea_type, tea_num, tea_price, tea_date, location, m_id) 
                              VALUES ('$t_name_ch', '$t_num', '$t_price', '$date', '$address', '$m_id');";
